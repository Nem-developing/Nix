        ...
        <div class="serveurs center">
            ...
            while ($ligne = $res->fetch(PDO::FETCH_OBJ)) {
                ...
                <div class='card-body'> 
                    ...
                    <a href='actions/lanceroustoper.php?id=$ligne->id&action=lancer' class='btn btn-success'>Démarer</a>
                    <a href='actions/lanceroustoper.php?id=$ligne->id&action=stopper' class='btn btn-danger'>Eteindre</a>
                </div>
            </div>";   
            }
            ?>
