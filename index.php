    ...
    <body>
        ...
        <div class="serveurs center">
            ...
            while ($ligne = $res->fetch(PDO::FETCH_OBJ)) {
                ...
                <div class='card-body'> 
                    <a href='actions/modifier-un-serveur.php?id=$ligne->id' class='card-link pencil'><svg class='bi bi-pencil' width='1em' height='1em' viewBox='0 0 16 16' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <a href='actions/lanceroustopper.php?id=$ligne->id&action=lancer' class='btn btn-success'>Démarer</a>
                    <a href='actions/lanceroustopper.php?id=$ligne->id&action=stopper' class='btn btn-danger'>Eteindre</a>
                </div>
            </div>";   
            }
            ?>
