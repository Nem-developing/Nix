...
<html lang="en">
    <head>
        ...
        <link href="../css/server-properties.css" rel="stylesheet" type="text/css"/>
        <title>Modification d'un fichier server.properties !</title>
    </head>
    <body>
    ...
    <center>
        <div id="page">            
            ...
            (int) $erreur = 0; // Variable qui controle l'érreur.
